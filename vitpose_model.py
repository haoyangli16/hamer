...
# Use the directory of this file as root if not specified
if "HAMER_ROOT" in os.environ:
    ROOT_DIR = os.environ["HAMER_ROOT"]
else:
    ROOT_DIR = os.path.dirname(os.path.abspath(__file__))

# Handle ViTPose path - check for embedded or sibling directory
if os.path.exists(os.path.join(ROOT_DIR, "third-party/ViTPose")):
    VIT_DIR = os.path.join(ROOT_DIR, "third-party/ViTPose")
elif os.path.exists(os.path.join(ROOT_DIR, "../ViTPose")):
...
if "VITPOSE_DIR" in os.environ:
    VIT_DIR = os.environ["VITPOSE_DIR"]

# Allow override for data dir
DATA_DIR = os.environ.get("HAMER_DATA_DIR", os.path.join(ROOT_DIR, "_DATA"))
